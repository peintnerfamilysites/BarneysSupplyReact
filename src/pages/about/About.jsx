...
// Search Engine Optimization (SEO) Component Import
  ...
  return (
    <>
      <Seo
        ...
        description="Learn about Barneys Supply Company, a Southwest Missouri exterior construction company serving the Ozarks with roofing, siding, gutters, and dependable property services since 1944."
        path="/about"
      />
          ...
          <div className="w-full max-w-[96vw] px-4 mt-6 md:mt-8 mb-6 md:mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="w-full md:w-2/3 text-center md:text-left max-w-2xl">
              ...
              <p className="text-zinc-400 mt-4 text-sm md:text-lg leading-relaxed">
                ...
                dependable exterior construction in Southwest Missouri. We
                combine multi-generational craftsmanship with modern, premium
                solutions to protect and elevate your home.
              </p>
            </div>
              ...
              <div className="w-full h-full bg-zinc-950 rounded-xl p-6 md:p-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-zinc-400 text-sm md:text-base leading-relaxed">
                  <p>
                    ...
                    alongside our communities, adapting to new technologies
                    while holding fast to the honest, old-school values that
                  ...
                  <p>
                    ...
                    diagnostics after an Ozark storm, executing precision
                    seamless gutter installations, or transforming residential
                    profiles with premium vinyl siding, our team treats every
                    single project as a testament to our 80-plus-year legacy.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full max-w-[96vw] px-4 grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="p-6 bg-zinc-950/80 backdrop-blur-sm rounded-xl border border-zinc-800/60 hover:border-red-600/40 transition-all group">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                We provide completely transparent metrics, straightforward
                quotes, and realistic timelines. No structural shortcuts, no
                hidden surprises.
              </p>
            </div>
            ...
            <div className="p-6 bg-zinc-950/80 backdrop-blur-sm rounded-xl border border-zinc-800/60 hover:border-yellow-500/40 transition-all group">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                ...
                installation methods to ensure your home investment holds up
                over decades.
              </p>
            </div>
          ...
          <div className="w-full max-w-[96vw] px-4 mb-6">
            <div className="bg-zinc-950/40 border border-zinc-900/80 rounded-xl p-8 text-center relative overflow-hidden backdrop-blur-xs">
              ...
              <p className="text-zinc-400 text-sm max-w-xl mx-auto mt-2 mb-6 leading-relaxed">
                ...
                framework headache. Contact Barneys Supply for
                professional-grade upkeep.
              </p>
