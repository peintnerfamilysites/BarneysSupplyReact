        ...
        <div className="w-full max-w-[96vw] px-4 mt-6 md:mt-8 mb-6 md:mb-10 text-center md:text-left">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
              Struggling with{" "}
              <span className="text-red-500">Storm Claims?</span>
            </h1>
            <p className="text-zinc-400 mt-4 text-sm md:text-lg leading-relaxed">
              Dealing with storm damage is stressful enough—you shouldn't have
              to battle insurance adjusters alone. Barneys Supply stands between
              you and the paperwork to make sure your home gets the full
        ...
        <div className="w-full max-w-[96vw] px-4 grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          ...
          <div className="p-6 md:p-8 bg-zinc-950/80 backdrop-blur-sm rounded-xl border border-zinc-900/80 flex flex-col justify-center">
            ...
            <p className="text-zinc-400 text-sm md:text-base leading-relaxed mb-4">
              Since 1944, we've cataloged, mapped, and executed roofing and
              siding replacements across the Ozarks. We don't guess at damage
              metric specs—we supply your carrier with undeniable, photographic
        ...
        <div className="w-full max-w-[96vw] px-4 mb-8">
          <div className="bg-zinc-950 border border-zinc-900 rounded-xl p-6 md:p-8 shadow-inner">
            ...
            <p className="text-zinc-500 text-xs md:text-sm mb-6 leading-relaxed">
              Input your specific project tracking info below to instantly build
              a localized compliance checklist and target action sequence.
            </p>
            ...
            <div className="space-y-6 text-sm">
              <div>
                ...
                <p className="text-zinc-400 mt-1 leading-relaxed">
                  ...
                  raise your personal premium costs for "Acts of Nature" like
                  hail or widespread regional wind storms. Adjustments are
                  rolled out entirely by entire zip code metrics or geographic
                  market segments.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-zinc-400 mt-1 leading-relaxed">
                  ...
                  immediately. Leaving structural vulnerabilities untreated
                  risks total interior denial later on.
                </p>
              </div>
            </div>
          </div>
